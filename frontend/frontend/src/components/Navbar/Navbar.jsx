...
//   const { connect, address } = useStateContext();
  ...
  const address = 'Create a campaign'


  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-5">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        ...
        {/* <Link to="/profile"> */}
          <div className="w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <Image src={thirdweb} className="w-[60%] h-[60%] object-contain"/>
          </div>
        {/* </Link> */}
      </div>
      ...
      {/* Small screen navigation */}
        ...
        <div className="w-[40px] h-[40px] rounded-[10px] bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <img src={""} alt="logo" className="w-[60%] h-[60%] object-contain" />
          </div>
